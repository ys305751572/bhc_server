				...
				<div id="loginBlock" class="login">
					<form class="loginForm" autocomplete="off" action="${contextPath}/login" id="formID" method="post">
						...
						<div class="loginFormIpt loginFormIptWiotTh">
							<div id="userNameInputLine" class="loginFormIpt showPlaceholder" style="float: left; margin: 0px 10px 0px 0px;clear: none;" >
						...
						<div class="loginFormIpt loginFormIptWiotTh">
							<div id="pwdInputLine" class="loginFormIpt showPlaceholder" style="float: left; margin: 0px 10px 0px 0px;clear: none;" >
