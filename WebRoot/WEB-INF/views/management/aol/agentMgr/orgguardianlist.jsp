    ...
    return format;
		...
		<script type="text/javascript">
				...
				function nameRender(row){
					...
					return '<a href="javascript:setGuardianlist(\''+row.userId+'\');">' + _ss_name + '</a>';
				}
				...
				//查看用户信息
			    function setGuardianlist(userId){
					if(!userId){
					...
					window.location.href = "${contextPath}/management/urgentperson/guardianlist?userId="+dataTableObj.getSelectedRow().userId;
				}
		</script>
	</head>
	<body>
		...
		<div class="row-fluid z-ulnone" id="proList">
			<div class="box span12">			
				...
				<div class="breadcrumb">
					<li><a href="javascript:setGuardianlist();" class="button button-rounded button-flat button-tiny" style="width: 120px;"><i class="icon-6" style="width: 20px; height: 20px; line-height: 20px;"></i>&nbsp;监护人设置</a></li>
				</div>
				<!-- 操作按钮end -->
