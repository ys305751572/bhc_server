	...
	if(result){
		if(result.success){
			...
			jAlert(result.msg,'提示',function(){
				window.location.href = '${contextPath}/management/organise/viewowninfo';
			});
		}else{
			//失败
				...
				<div class="row-fluid z-ulnone">
					<div class="box span12">
						<div class="box-header well z-h2">
							<h2><i class="icon-briefcase"></i> 编辑基本信息</h2>
							<jsp:include page="/WEB-INF/views/backDiv.jsp" flush="true">
								<jsp:param name="url" value="${contextPath}/management/organise/viewowninfo"/>
							</jsp:include>
						</div>
						<div class="box-content">
							<!--table2-->
							<form class="form-horizontal" method="post" id="restarteProForm" action="${contextPath}/management/organise/saveOwnInfo" enctype="multipart/form-data">
											...
											<td colspan="2">
												<div class="control-group">
													...
													<div class="controls">
														...
														<input name="parentId" type="hidden" value="${org.parentId}" />
