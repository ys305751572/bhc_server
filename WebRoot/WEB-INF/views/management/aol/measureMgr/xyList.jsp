...
Date.prototype.format = function(format){
    ...
    return format;
		...
		<script type="text/javascript">
				...
				var columns = [ {'text':'用户姓名','dataIndex':'measureName','render':measureNameRender,'width':'70px'},
							    {'text':'设备类型','dataIndex':'measureType','render':measureTypeRender,'width':'60px'},
							    {'text':'测量状态','dataIndex':'measureState','render':measureStateRender,'width':'60px'},
							    {'text':'测量收缩压','dataIndex':'result2','width':'60px'},
							    {'text':'高压状态','render':gyztRender,'width':'50px'},
							    {'text':'预警收缩压','render':yjgyRender,'width':'70px'},
							    {'text':'测量舒张压','dataIndex':'result3','width':'60px'},
				...
				var dataTableObj ;
				$(function() {
					dataTableObj  = new czTools.dataTable({"columns":columns,"render":"xyListDataTable",
												"url":"${contextPath}/management/measure/getXyDataList",
												"para":arrayObj,
		...
		<div class="row-fluid z-ulnone" id="proList">
			<div class="box span12">			
				<div class="box-content"   style="padding: 0px;border: 0px">
					...
					<!-- 列表start -->
					<div id="xyListDataTable" class="z-informa2"></div> 
					<!-- 列表end -->
				</div> 
			</div> 
		</div> 
