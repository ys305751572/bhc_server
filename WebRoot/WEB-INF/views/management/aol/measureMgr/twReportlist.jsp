...
$(document).ready(function(){
	...
	$('#usertree').tree({ 
			url:'${contextPath}/management/measure/reporttwTreeList',
...
function searchBtnClick(){
	$('#usertree').tree("options").url = '${contextPath}/management/measure/reporttwTreeList?usersname='+$("#usersname").val();
...
function daleteSeries(){
	...
	<body>
		...
		<input type="hidden" id = "pageType" value="tw" /><!-- 因为调用的是一个JS方法，在此设定区分参数，用来执行不同的方法 -->
		<!--detail start-->
