...
$(document).ready(function(){
	...
	$('#usertree').tree({ 
			url:'${contextPath}/management/measure/reportxyTreeList',
...
function searchBtnClick(){
    $('#usertree').tree("options").url = '${contextPath}/management/measure/reportxyTreeList?usersname='+$("#usersname").val();
...
function daleteSeries(){
	...
	<body>
		...
		<input type="hidden" id = "pageType" value="xy" /><!-- 因为调用的是一个JS方法，在此设定区分参数，用来执行不同的方法 -->
		<!--detail start-->
				...
				<div class="box-content"   style="padding: 0px">
					...
					<tr>
						<td width="100%">
							...
							<div id="gdiframe" width="100%" height="450px" style="border: 1"></div>
						</td>
						<td align="right" width="300px">
							<table border="0px" style="height:20px;word-break:keep-all;white-space:nowrap;float:left;margin-top:20px;">
								<tr>
									<td>
										<div>
											<form id="form1" name="form1" class="form-horizontal" action="" method="post" enctype="multipart/form-data">
											<input id="usersname" name="usersname" type="text" value="" style="width: 90px; height: 15px;" />
