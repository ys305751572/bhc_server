...
Date.prototype.format = function(format){
    ...
    return format;
		...
		<script type="text/javascript">
				...
				var dataTableObj ;
				$(function() {
					dataTableObj  = new czTools.dataTable({"columns":columns,"render":"draftboxListDataTable",
												"url":"${contextPath}/management/messages/getDraftboxDataList",
												"para":arrayObj,
				...
				function sendMsg(){
					if(!dataTableObj.getSelectedRow()){
						...
						window.location.href = "${contextPath}/management/messages/sendmessage?messagesId="+dataTableObj.getSelectedRow().messagesId;
					}
				}
		...
		<div class="row-fluid z-ulnone" id="proList">
			<div class="box span12">			
				...
				<div class="breadcrumb">
					<li><a href="javascript:sendMsg();" class="button button-rounded button-flat button-tiny" style="width: 60px;"><i class="icon-13" style="width: 20px; height: 20px; line-height: 20px;"></i>&nbsp;发送</a></li>
				...
				<div class="box-content" style="margin: -15px;">
					<!-- 列表start -->
					<div id="draftboxListDataTable" class="z-informa2"></div> 
					<!-- 列表end -->
				</div> 
			</div> 
		</div> 
