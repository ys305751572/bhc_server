								...
								<table border="0" cellspacing="0" cellpadding="0">
									<tr>
										<td style="word-break:break-all;padding:2px 12px 0 14px;line-height:19px;text-align: left;" width="99%" >
											<span style="color: #8fa7b3;">发件人：</span><b style="font: normal 12px 'lucida Grande',Verdana,'Microsoft YaHei';color: #5fa207;">${message.messagesSenderName}</b>
										</td>
									</tr>
									<tr>
										<td style="word-break:break-all;padding:2px 12px 0 14px;line-height:19px;text-align: left;" width="99%" >
											<span style="color: #8fa7b3;">时&nbsp;&nbsp;&nbsp;间：</span><b style="font: normal 12px 'lucida Grande',Verdana,'Microsoft YaHei';color: #7f7f7f;">2014年11月10日(星期一) 下午2:03</b>
										</td>
									</tr>
									<tr>
										<td style="padding:0 0 0 14px;line-height:19px;text-align:left;">
											<div>
												<div style="color: #8fa7b3;white-space: nowrap;position:absolute;">收件人：</div>
												<div style="padding-left:48px;font-size:12px;overflow:hidden; zoom:1;">${message.messagesSendeeName}</div>
