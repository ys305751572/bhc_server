...
Date.prototype.format = function(format){
		...
		<script type="text/javascript">
				...
				$(function() {
					dataTableObj  = new czTools.dataTable({"columns":columns,"render":"xtListDataTable",
												"url":"${contextPath}/management/position/hjDateList",
												"para":arrayObj,
	...
	<body>
		<!-- 设置地图坐标属性 -->
		<input type="hidden" id = "hzb" value="116.397428"/>
		<input type="hidden" id = "zzb" value="39.90923"/>
		<input type="hidden" id = "contextPath" />
		<input type="hidden" id = "pageType" value="gddd" /><!-- 因为调用的是一个JS方法，在此设定区分参数，用来执行不同的方法 -->
		<!--detail start-->
			...
			<div class="box span12">			
				<div class="box-content"  style="padding: 0px">
					...
					<tr>
						...
						<td width="99%">
							<iframe id="gdiframe" src='${contextPath}/management/position/gddhpagedd' width="99%" height="450px" style="border:0px"></iframe>
						</td>
